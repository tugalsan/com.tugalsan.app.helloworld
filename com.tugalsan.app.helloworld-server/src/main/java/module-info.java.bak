module com.tugalsan.app.helloworld.server {
    requires com.tugalsan.app.helloworld.shared;
    ...
    requires com.tugalsan.api.sql.col;
    ...
    requires com.tugalsan.lib.rql.cfg;
